...
const CONTENT = {
  ...
  topicOrder: [
    ...
    'dsss', 'frequency-hopping', 'processing-gain', 'jamming-margin', 'pn-codes', 'gold-code', 'dsss-acquisition', 'sliding-correlator', 'dsss-tracking', 'delay-lock-tracking', 'tau-dither-tracking', 'split-bit-tracking', 'dsss-data-extraction', 'dsss-receiver-design', 'channel-coding', 'fec', 'convolutional-codes', 'viterbi', 'trellis-diagram', 'turbo-codes', 'ldpc',
