...
CONTENT.topics.push(
...

  {
    ...
    numericals: [
      ...
      { q: String.raw`A 100 MHz carrier is undersampled at 40 MS/s. Find the alias (baseband) frequency and note any inversion.`, solution: String.raw`$k=\text{round}(100/40)=3$ (nearest is $2$ or $3$: $|100-2\times40|=20$, $|100-3\times40|=20$). Alias $=20$ MHz, right at Nyquist edge; choosing $k=2$ places it in zone... practically shift $f_s$ so the band sits cleanly. For $f_s=40$, alias $=|100-80|=20$ MHz.` },
